...
<section id="intro" style="padding-top:100px;" >
        <div class="container">
                ...
                <div class="col-sm-12">
                    <h1 align="center">WELCOME TO GALLERY SECTION</h1>
...
$query="SELECT * FROM `gallery` ORDER BY sno DESC;";
...
$rs=my_select($query);
								...
								while($row=mysqli_fetch_array($rs))
								{
									...
									if (!($row['image']==NULL))
									echo '<p ><img class="img-responsive" style="padding:30px; float:left; padding-top:60px;" src="data:image;base64,'.base64_encode($row['image']) .'"><br/>';
									else echo"<br/>&nbsp;";
									echo "<blockquote class='blockquote' style='text-align:justify'>$row[3]<br/>&nbsp;";
									echo "<footer>Designed & Worked Upon By :<strong> CykoTechnology </strong>&nbsp;";
									...
									echo " <h2 align='center' style='color:#ff6d06'><strong>$row[1]</strong></h1>";
									if (!($row['image']==NULL))
									echo '<p ><img class="img-responsive" style=" padding:30px; float:right; padding-top:60px; " src="data:image;base64,'.base64_encode($row['image']) .'"><br/>';
									else echo"<br/> &nbsp;";
